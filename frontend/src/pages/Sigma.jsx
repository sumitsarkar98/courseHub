...
const Sigma = () => {
  return (
    <div>
      ...
      <section
        id="sigma-one"
        className="my-1 bg-[#e9f2fd] px-2 lg:px-20 py-24 md:py-36 xl:flex flex-col-reverse md:flex-row justify-center items-center"
      >
        {/* Left Text Content */}
        <div className="w-full md:w-2/3 flex flex-col justify-center items-center text-center gap-4">
          {/* h1 aligned right */}
          <h1 className="w-full leading-loose sm:leading-[4] pr-4 text-center">
            <span className="text-black text-sm sm:text-xl xl:text-4xl font-bold">
              Sigma 8.0 :<br />
            </span>{" "}
            <span className="text-3xl xl:text-6xl font-bold tracking-wide">
          ...
          {/* button centered */}
          <button className="mt-4 bg-blue-700 text-white p-2 lg:px-6 lg:py-3 rounded-md hover:scale-105 transition-transform duration-300 ease-in-out text-lg sm:text-xl font-semibold">
            Enroll Now
          </button>
        </div>
